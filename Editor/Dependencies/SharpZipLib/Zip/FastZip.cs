...
using static ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Zip.Compression.Deflater;
using static ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Zip.ZipEntryFactory;
