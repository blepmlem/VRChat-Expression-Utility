...
using System.Text;
using ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Checksum;
using ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Core;
using ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Encryption;
using ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Zip.Compression;
using ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Zip.Compression.Streams;

namespace ICSharpCodeRenamedToAvoidConflictWithOldSDKs.SharpZipLib.Zip
{
